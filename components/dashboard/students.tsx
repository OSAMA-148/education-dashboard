...
export function StudentsSection() {
    ...
    return (
        <div className="space-y-6">
                ...
                >
                    ...
                    <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                أدخل بيانات الطالب لتسجيله في النظام.
                            </DialogDescription>
                        </DialogHeader>
                                ...
                                <div className="col-span-3 space-y-2">
                                    {availableSubjects.map((subject) => (
                                        ...
                                        >
                                            <Checkbox
                                                id={subject}
                                                checked={newStudent.subjects.includes(
                                                    subject
                                                )}
            ...
            <Card>
                <CardHeader>
                    <CardTitle>كل الطلاب</CardTitle>
                    <CardDescription>
                        عرض وإدارة تسجيلات الطلاب وحالة الرسوم
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="text-right">المعلم الأساسي</TableHead>
                        ...
                        <TableBody>
                            {students.map((student) => (
                                <TableRow key={student.id}>
                                    ...
                                    <TableCell>
                                        {student.teacher === "Dr. Johnson"
                                            ? "د. جونسون"
                                            : student.teacher === "Dr. Davis"
                                            ? "د. ديفيس"
                                            : student.teacher === "Prof. Chen"
                                            ? "أ. تشين"
                                            : student.teacher}
                                    </TableCell>
                                    <TableCell>
