		...
		<div className="space-y-6">
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				<Card>
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground">من الرسوم المدفوعة</p>
					</CardContent>
				</Card>
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground">
							{feeRecords.filter((r) => r.status === "Pending").length} طلاب
						</p>
					</CardContent>
				</Card>
				<Card>
					...
					<CardContent>
						...
						<p className="text-xs text-muted-foreground">
							{feeRecords.filter((r) => r.status === "Overdue").length} طلاب
						</p>
					</CardContent>
				</Card>
				<Card>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>تتبع وإدارة مدفوعات رسوم الطلاب</CardDescription>
				</CardHeader>
				<CardContent>
					<Table>
						<TableHeader>
